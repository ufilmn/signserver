...
/**
 * Used both for loading a server during performance testing and postprocessing
 * resulting CSV statistics.
 *
 * @version $Id: PDFPerformanceCommand.java 7376 2016-05-23 06:53:38Z malu9369 $
 */
    ...
    private void postProcessRawData(String[] args) {
        ...
        for (File file : csvFiles) {
            ...
            try (BufferedReader br
                ...
                ArrayList<ArrayList<Long>> roundedData = new ArrayList<>();
                ArrayList<Long> uniqueTimes = new ArrayList<>();
                long startTime = 0;
